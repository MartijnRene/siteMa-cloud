...
function finishQuiz() {
  ...
  if(playerData.goodAnswers >= 2){
    resultBox.innerHTML = "<h2>Met " + playerData.goodAnswers + " goede andwoorden en " + playerData.wrongAnswers + " foute antwoorden heeft u een prijs gewonnen!<br>We hebben alleen nog uw creditcardgegevens nodig.</h2>";
  }
  else {
    resultBox.innerHTML = "<h2>Helaas, met " + playerData.goodAnswers + " goede andwoorden en " + playerData.wrongAnswers + " foute antwoorden heeft u geen prijs gewonnen.<br>Misschien heeft u volgende keer meer geluk als u uw e-mail bij ons achterlaat.</h2>";
  }
